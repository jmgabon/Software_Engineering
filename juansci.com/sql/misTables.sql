...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2020 at 03:32 PM
...
INSERT INTO `temp_roomcreation` (`ControlNum`, `RoomNum`, `RoomName`, `Building`, `Floor`, `Type`, `DateCreated`, `CreatedBy`, `Action`, `Status`, `ApprovedBy`, `ApprovalDate`, `Remarks`) VALUES
(1, 101, '101', 'ITC', 1, 'Classroom', '2020-03-01 14:26:51', 2, 'INSERT', 'WAITING', NULL, NULL, NULL),
(2, 102, '102', 'ITC', 1, 'Classroom', '2020-03-01 14:31:31', 2, 'INSERT', 'WAITING', NULL, NULL, NULL);
...
INSERT INTO `temp_teacherregistration` (`ControlNum`, `TeacherNum`, `Shift`, `Major`, `LastName`, `ExtendedName`, `FirstName`, `MiddleName`, `Gender`, `Birthday`, `BirthPlace`, `Email`, `CellphoneNum`, `LandlineNum`, `URL_Picture`, `Present_StreetAdd`, `Present_City`, `Present_Province`, `Present_Country`, `Permanent_StreetAdd`, `Permanent_City`, `Permanent_Province`, `Permanent_Country`, `CreatedBy`, `Action`, `DateCreated`, `Status`, `ApprovedBy`, `ApprovalDate`, `Remarks`) VALUES
...
(3, NULL, 'AM', 'AP', 'Gabon', NULL, 'Jose Mari', 'Manuel', 'Male', '1997-03-28', 'Pasig City', 'gabonjosemari@gmail.com', NULL, '9002594', '46280_541687292517090_621937474_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:27:42', 'WAITING', NULL, NULL, ''),
(4, NULL, 'AM', 'AP', 'Gabon', NULL, 'Carlos Miguel', 'Manuel', 'Male', '1999-01-22', 'Pasig City', NULL, NULL, NULL, '407093_355692657777994_1875201973_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:31:26', 'WAITING', NULL, NULL, ''),
(5, NULL, 'AM', 'AP', 'Gabon', NULL, 'Patrick', 'Manuel', 'Male', '1998-11-20', 'Pasig City', NULL, NULL, NULL, '76371_541686522517167_1955437084_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:33:08', 'WAITING', NULL, NULL, ''),
(6, NULL, 'PM', 'ESP', 'Oprenario', NULL, 'Leslie Alexis', 'Manuel', 'Female', '1990-03-31', 'Pasig City', NULL, NULL, NULL, '430082_541686969183789_1029801639_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:34:49', 'WAITING', NULL, NULL, ''),
(7, NULL, 'PM', 'FIL', 'Cadayona', NULL, 'Gracielle Mae', 'Manuel', 'Female', '1987-06-24', 'Malabon City', NULL, NULL, NULL, '76371_541686522517167_1955437084_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:38:30', 'WAITING', NULL, NULL, ''),
(8, NULL, 'PM', 'SCI', 'Gubat', NULL, 'Edward', NULL, 'Male', '1990-03-12', 'Pasig City', NULL, NULL, NULL, '409104_346205608731927_533903614_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 07:39:58', 'WAITING', NULL, NULL, ''),
(11, NULL, 'AM', 'RESEARCH', 'Gabon', NULL, 'Mary Ann', NULL, 'Female', '1973-05-02', 'Malabon City', NULL, NULL, NULL, '430082_541686969183789_1029801639_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 12:48:06', 'WAITING', NULL, NULL, ''),
(12, NULL, 'AM', 'TLE', 'Gabon', NULL, 'Ernesto', 'Baccol', 'Male', '1969-01-03', 'Manila City', NULL, NULL, NULL, '430082_541686969183789_1029801639_n.jpg', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', NULL, 'Pasig City', 'Metro Manila', 'Phillipines', 2, 'INSERT', '2020-03-01 08:51:01', 'WAITING', NULL, NULL, '');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `summary_studentregistration`  AS  select `temp_studentregistration`.`ControlNum` AS `ControlNum`,`temp_studentregistration`.`LastName` AS `LastName`,`temp_studentregistration`.`FirstName` AS `FirstName`,`temp_studentregistration`.`MiddleName` AS `MiddleName`,`temp_studentregistration`.`CreatedBy` AS `CreatedBy`,`temp_studentregistration`.`Action` AS `Action`,`temp_studentregistration`.`Status` AS `Status`,`temp_studentregistration`.`URL_Picture` AS `URL_Picture` from `temp_studentregistration` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `summary_teacherregistration`  AS  select `temp_teacherregistration`.`ControlNum` AS `ControlNum`,`temp_teacherregistration`.`LastName` AS `LastName`,`temp_teacherregistration`.`FirstName` AS `FirstName`,`temp_teacherregistration`.`MiddleName` AS `MiddleName`,`temp_teacherregistration`.`CreatedBy` AS `CreatedBy`,`temp_teacherregistration`.`Action` AS `Action`,`temp_teacherregistration`.`Status` AS `Status`,`temp_teacherregistration`.`URL_Picture` AS `URL_Picture` from `temp_teacherregistration` ;
