...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2020 at 09:01 AM
...
(104, NULL, NULL, NULL, 'Classroom', '0000-00-00 00:00:00'),
(200, 'Maharlika', 'Don Mariano', 2, 'Classroom', '2020-03-08 20:54:55'),
...
('22', 'RESEARCH7-14', 'Monday', '7:00-8:00', '2020-03-09 16:00:38'),
('23', 'SCI7A-14', 'Tuesday', '7:00-8:00', '2020-03-09 16:00:38'),
('24', 'SCI7A-14', 'Thursday', '7:00-8:00', '2020-03-09 16:00:38'),
('25', 'SCI7A-14', 'Wednesday', '7:00-8:00', '2020-03-09 16:00:38'),
('26', 'SCI7A-14', 'Friday', '7:00-8:00', '2020-03-09 16:00:38'),
...
(14, 'Our Lady of Good Success', 103, 7, 17, '0000-00-00 00:00:00');
...
('RESEARCH7-14', 17, 14, 'RESEARCH 7', '2020-03-09 16:00:38'),
('SCI7A-14', 17, 14, 'SCI 7A', '2020-03-09 16:00:38');
...
('AP 11', 'Araling Panlipunan 11', 7, 3, '0000-00-00 00:00:00'),
...
--
-- Stand-in structure for view `masterlist_schedule`
-- (See below for the actual view)
--
CREATE TABLE `masterlist_schedule` (
...
('5e65f78504fa5', 14, 2, '2020-03-09 08:00:05', 'CREATE', 'PENDING', NULL, NULL, NULL),
('5e65f7996fe7d', 14, 2, '2020-03-09 08:00:25', 'CREATE', 'APPROVED', 2, '2020-03-09 16:00:38', NULL);
...
(1, 101, '101', 'ITC', 1, 'Classroom', '2020-03-01 14:26:51', 2, 'CREATE', 'APPROVED', 1, '2020-03-03 02:33:34', NULL),
(2, 102, '102', 'ITC', 1, 'Classroom', '2020-03-01 14:31:31', 2, 'CREATE', 'APPROVED', 1, '2020-03-05 02:57:57', NULL),
(3, 103, '101', 'ITC', 1, 'Classroom', '2020-03-01 18:52:54', 2, 'CREATE', 'APPROVED', 1, '2020-03-05 03:22:07', NULL),
(4, 104, '104', '1', 1, 'Classroom', '2020-03-01 18:54:08', 2, 'CREATE', 'REJECTED', 1, '2020-03-03 02:30:50', NULL),
(5, 201, '201', 'ITC', 2, 'Classroom', '2020-03-04 19:18:31', 2, 'CREATE', 'APPROVED', 1, '2020-03-05 03:18:40', NULL),
(6, 104, NULL, NULL, NULL, 'Classroom', '2020-03-06 12:05:10', 2, 'CREATE', 'REJECTED', 1, '2020-03-08 21:22:04', NULL),
(7, 104, NULL, NULL, NULL, 'Classroom', '2020-03-06 12:05:37', 2, 'CREATE', 'APPROVED', 1, '2020-03-08 22:34:15', NULL),
(8, 104, NULL, NULL, NULL, 'Classroom', '2020-03-06 12:07:36', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(9, 104, '104', 'ITC', 1, 'Classroom', '2020-03-06 12:19:30', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(10, 104, '104', 'ITC', 1, 'Classroom', '2020-03-07 10:20:33', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(11, 200, 'Maharlika', 'Don Mariano', 2, 'Classroom', '2020-03-08 12:53:40', 2, 'CREATE', 'APPROVED', 1, '2020-03-08 20:54:55', NULL),
(12, 104, '104', 'Don Mariano', 1, 'Classroom', '2020-03-08 13:09:52', 2, 'CREATE', 'PENDING', NULL, NULL, NULL);
...
(15, '5e65f78504fa5MAPEH7', 'Monday', '6:00-7:00'),
(16, '5e65f78504fa5MAPEH7', 'Tuesday', '6:00-7:00'),
(17, '5e65f78504fa5MAPEH7', 'Wednesday', '6:00-7:00'),
(18, '5e65f78504fa5MAPEH7', 'Thursday', '6:00-7:00'),
(19, '5e65f78504fa5AP11', 'Friday', '6:00-7:00'),
(20, '5e65f78504fa5AP11', 'Tuesday', '7:00-8:00'),
(21, '5e65f78504fa5AP11', 'Wednesday', '7:00-8:00'),
(22, '5e65f7996fe7dRESEARCH7', 'Monday', '7:00-8:00'),
(23, '5e65f7996fe7dSCI7A', 'Tuesday', '7:00-8:00'),
(24, '5e65f7996fe7dSCI7A', 'Thursday', '7:00-8:00'),
(25, '5e65f7996fe7dSCI7A', 'Wednesday', '7:00-8:00'),
(26, '5e65f7996fe7dSCI7A', 'Friday', '7:00-8:00');
...
(1, NULL, 'Kamias', 101, 8, 16, '2020-03-09 03:05:54', 2, 'CREATE', 'APPROVED', 1, '2020-03-03 18:06:19', NULL),
(3, NULL, 'Caimito', 101, 7, 17, '2020-03-09 03:07:12', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(4, NULL, 'Sumakwel', 102, 7, 16, '2020-03-09 03:07:12', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(5, NULL, 'Sumakewel', 102, 7, 15, '2020-03-09 03:07:12', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(6, NULL, 'Mayana', 201, 8, 15, '2020-03-09 07:40:50', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(7, NULL, 'Naro', 103, 7, 17, '2020-03-09 07:40:56', 2, 'CREATE', 'PENDING', NULL, NULL, NULL),
(8, NULL, 'Our Lady of Good Success', 103, 7, 17, '2020-03-09 07:44:02', 2, 'CREATE', 'APPROVED', 1, '2020-03-09 15:44:02', NULL),
(9, NULL, 'Tekamuna', 200, 7, 2, '2020-03-09 07:41:01', 2, 'CREATE', 'PENDING', NULL, NULL, NULL);
...
('5e65f78504fa5AP11', '5e65f78504fa5', 'AP11-14', 2, 14, 'AP 11'),
('5e65f78504fa5MAPEH7', '5e65f78504fa5', 'MAPEH7-14', 17, 14, 'MAPEH 7'),
('5e65f7996fe7dRESEARCH7', '5e65f7996fe7d', 'RESEARCH7-14', 17, 14, 'RESEARCH 7'),
('5e65f7996fe7dSCI7A', '5e65f7996fe7d', 'SCI7A-14', 17, 14, 'SCI 7A');
...
(5, 'AP 11', 'Araling Panlipunan 11', 7, 3, '2020-03-08 15:12:28', 2, 'INSERT', 'APPROVED', 1, '2020-03-08 23:12:28', NULL),
(6, 'AP 11', 'Araling Panlipunan 11', 7, 3, '2020-03-08 12:50:42', 2, 'INSERT', 'PENDING', NULL, NULL, NULL);
...
--
-- Structure for view `masterlist_schedule`
--
DROP TABLE IF EXISTS `masterlist_schedule`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `masterlist_schedule`  AS  select `main_section`.`SectionName` AS `SectionName`,`main_section`.`GradeLevel` AS `GradeLevel`,if(isnull(`advisory`.`MiddleName`),concat(`advisory`.`LastName`,if(isnull(`advisory`.`ExtendedName`),'',`advisory`.`ExtendedName`),', ',`advisory`.`FirstName`,'',''),concat(`advisory`.`LastName`,' ',if(isnull(`advisory`.`ExtendedName`),'',`advisory`.`ExtendedName`),', ',`advisory`.`FirstName`,' ',left(`advisory`.`MiddleName`,1),'.')) AS `Adviser`,`main_subject`.`SubjectID` AS `SubjectID`,`main_subject`.`SubjectCode` AS `SubjectCode`,`main_sched`.`SchedID` AS `SchedID`,`main_sched`.`SubjectDay` AS `SubjectDay`,`main_sched`.`SubjectTime` AS `SubjectTime`,`main_subject`.`TeacherNum` AS `TeacherNum`,if(isnull(`teacher`.`MiddleName`),concat(`teacher`.`LastName`,if(isnull(`teacher`.`ExtendedName`),'',`teacher`.`ExtendedName`),', ',`teacher`.`FirstName`,'',''),concat(`teacher`.`LastName`,' ',if(isnull(`teacher`.`ExtendedName`),'',`teacher`.`ExtendedName`),', ',`teacher`.`FirstName`,' ',left(`teacher`.`MiddleName`,1),'.')) AS `TeacherName` from ((((`main_subject` left join `main_sched` on((`main_subject`.`SubjectID` = `main_sched`.`SubjectID`))) left join `main_section` on((`main_subject`.`SectionNum` = `main_section`.`SectionNum`))) left join `main_teacher` `advisory` on((`advisory`.`TeacherNum` = `main_section`.`Adviser`))) left join `main_teacher` `teacher` on((`teacher`.`TeacherNum` = `main_subject`.`TeacherNum`))) group by `main_sched`.`SchedID` ;
...
--
ALTER TABLE `main_section`
  MODIFY `SectionNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `temp_sched`
  MODIFY `SchedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `temp_sectioncreation`
  MODIFY `ControlNum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
