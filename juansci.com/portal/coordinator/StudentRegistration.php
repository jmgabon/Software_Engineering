...
<div class="content-main mt-4" id="Student">
   <form>
   <div id = "FirstCol">
   <div id="ApplicantSection"><h2 class="pt-3 pb-2"><b>APPLICANT'S SECTION</b></h2>
   	<div class="photo-div">
   ...
   <p><label for="Extension">Extended Name: </label><input type="text" id = "Extension" name = "Extension"/></p>
    ...
    <div id="Present_Address">
      ...
      <p class="h5 pt-3 pb-2">Current Address</p>
		<p><label for="Present_StreetAdd">Street Address: </label><input type="text" id = "Present_StreetAdd" name = "Present_StreetAdd" required></p>
		<p><label for="Present_City">City: </label><input type="text" id = "Present_City" name = "Present_City" required></p>
		<p><label for="Present_Province">Province: </label><input type="text" id = "Present_Province" name= "CProvince" required></p>
    ...
    <div id="Permanent_Address" style="display: none;">
      <p class="h5 pt-3 pb-2">Permanent Address</p>
		<p><label for="Permanent_StreetAdd">Street Address: </label><input type="text" id = "Permanent_StreetAdd" name = "Permanent_StreetAdd" required></p>
    ...
    <p><label for="Landline">Landline No.: </label><input type="text" id = "Landline" name = "Landline" required></p>
	<p><label for="Cellphone">Cellphone No.: </label><input type="text" id = "Cellphone" name = "Cellphone" required></p>
	...
	<p>
		...
		<input type="text" id = "Present_SchoolAddress" name = "Present_SchoolAddress" required/></p>
	<p>
		<label for="Present_SchoolContact">Contact No.</label>
		<input type="text" id = "Present_SchoolContact" name = "Present_SchoolContact" required/>
	</p>
	...
	<div id="ParentSection" style="margin-top: 1.5rem">
		...
		<h4 class="pt-3 pb-2">Mother's Information</h4>
			...
			<p>
				...
				<input type="text" id = "MotherContact" name = "MotherContact" required/>
			</p>
			<p>
		...
		<h4 class="pt-3 pb-2">Father's Information</h4>
			...
			<p>
				...
				<input type="text" id = "FatherContact" name = "FatherContact" required/>
			</p>	
			<p>
	...
	<div id= "ApplicationSection" style="margin-top: 1.5rem">
		...
		<div style="margin-left: 15% !important">
			<p><input type="checkbox" name="FifthReq"/><label for="FifthReq1">Billing Statement</label></p>
			<p><input type="checkbox" name="FifthReq"/><label for="FifthReq2">Driver's License</label></p>
			<p><input type="checkbox" name="FifthReq"/><label for="FifthReq3">Voter's ID</label></p>
		</div>
	</div>
