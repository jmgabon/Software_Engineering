let std_picture = document.querySelector("#FirstCol img");
let input_std_picture = document.querySelector(".photo-div input");
...
submitForm.addEventListener("click", function(event){
	...
	if(Permanent_Address.style.display == "none"){
		window.location.href = "StudentRegistration.php#Present_Address";
	}
	else{
		let ifblank = 0;
...
function InsertInfo(){
	...
	console.log(content);
	UploadPhoto(imageToUpload, "../../php/UploadStudentPhoto.php", null);
