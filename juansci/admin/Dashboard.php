            ...
            <div class="card shadow border-0 rooms">
              <div class="row mt-4 text-center">
                <div class="col-4 mt-3 ml-5">
                  <h1 class="count-text m-0">32</h1>
                  <p class="text-rooms">available</p>
                </div>
                <div class="col-4 mt-3">
                  <h1 class="count-text m-0">50</h1>
